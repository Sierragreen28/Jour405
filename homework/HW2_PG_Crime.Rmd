...
ANSWER HERE The data shows that the two largest categories of crime are accidents and auto theft, so from a reporting standpoint that is something to be aware of. Another thing i noticed amoung the data was that the majority of categories had higher rates at the end of the tear. 
